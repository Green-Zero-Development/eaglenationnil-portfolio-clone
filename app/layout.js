...
export default async function RootLayout({ children, page }) {
  ...
  {globalSections.map((item) => {
      ...
      } else if (item.title === "Ticker Items") {
        tickerItems.push(
            {"acf": item.acf },
        ) 
      } else {};
  ...
  return (
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://use.typekit.net/zfy1sbn.css" />
        ...
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-QT4VSC6LK8" />
